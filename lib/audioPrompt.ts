// Shared audio-conversion prompt logic — used by both the original API route
// and the Trigger.dev background task, so there's exactly one copy of this
// carefully-tuned prompt to maintain.
...
export function findMissingFixtures(transcript: string, rows: any[]): string[] {
