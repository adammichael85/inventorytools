...
@media(max-width:720px){section{padding:56px 0}.nav-links,.nav-right .login{display:none}.hamburger{display:block}.grid-3{grid-template-columns:1fr}.product-grid,.pricing-grid{grid-template-columns:1fr}.product.standout{order:-1}.steps{grid-template-columns:1fr}.hero{padding:48px 0 56px}.hero h1{font-size:2rem}.hero .sub{font-size:1rem}.hero-ctas{flex-direction:column;align-items:stretch}.hero-ctas .btn{width:100%;justify-content:center}.badges{gap:8px}.badge{font-size:.75rem;padding:5px 10px}.demo-panel{padding:16px}.flow-mid small{font-size:.7rem}.doc-body{font-size:.72rem}.doc-row{gap:4px;padding:4px 0}.toggle button{padding:7px 14px;font-size:.82rem}.product{padding:24px}.product h3{font-size:1.3rem}.product-foot{flex-direction:column;align-items:flex-start;gap:10px}.product-foot .btn{width:100%;justify-content:center}.ba-body{padding:14px}.price-card{padding:24px}.price-big{font-size:1.8rem}.pricing-grid{gap:16px}.receipt{padding:20px}.calc{padding:20px}.receipt-row{font-size:.88rem}.table-wrap{border-radius:12px}.table-line{font-size:1.1rem}.faq-q{font-size:.93rem;padding:15px 16px}.faq-a p{padding:0 16px 16px}.final{padding:64px 0}.final h2{font-size:1.6rem}.final .btn{width:100%;justify-content:center;margin-bottom:10px}.foot-row{flex-direction:column;text-align:center;gap:14px}.foot-row a{margin:0 10px}.foot-price{font-size:.8rem}.section-head{margin-bottom:36px}.section-head h2{font-size:1.6rem}.pull{font-size:1.1rem}.reassure{gap:14px;font-size:.82rem}.tabs{width:100%;border-radius:12px}.tabs button{padding:9px 16px;font-size:.85rem}.product ul{gap:8px}.icon-chip{width:36px;height:36px;font-size:1rem}.card{padding:20px}.card h3{font-size:1rem}}
