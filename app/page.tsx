...
@media(max-width:720px){section{padding:64px 0}.nav-links,.nav-right .login{display:none}.hamburger{display:block}.grid-3{grid-template-columns:1fr}.product-grid,.pricing-grid{grid-template-columns:1fr}.product.standout{order:-1}.steps{grid-template-columns:1fr}.hero{padding:56px 0 64px}.hero-ctas .btn{width:100%;justify-content:center}.final .btn{width:100%;justify-content:center;margin-bottom:10px}.foot-row{flex-direction:column;text-align:center}.foot-row a{margin:0 10px}}
