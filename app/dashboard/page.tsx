...
<p style={{ fontSize: 11, color: HINT, marginTop: 8 }}>For files over 3MB, compress first at ilovepdf.com
Use the EXTREME compression to reduce the file size dramatically to save conversion time.</p>
                  </div>
                </label>
    ...
    if (e.target.files?.[0]) { 
      ...
      setCompressing(false)
            ...
            {convertState === 'selected' && selectedFile && (
              <div style={{ padding: 24 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: BG, border: `1px solid ${BORDER}`, borderRadius: 10, padding: '14px 16px', marginBottom: selectedFile.size > 3 * 1024 * 1024 ? 12 : 20 }}>
