          ...
          {page === 'dashboard' && (
            <div>
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2,1fr)' : 'repeat(5,minmax(0,1fr))', gap: 16, marginBottom: 4 }}>
                <p style={{ fontSize: 11, fontWeight: 600, color: HINT, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 }}>Lifetime Statistics <span style={{ fontWeight: 400, textTransform: 'none', letterSpacing: 0 }}>— includes deleted reports</span></p>
